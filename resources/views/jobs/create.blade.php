<x-layout>
    ...
    <form method="POST" action="/jobs">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input type="text" name="salary" id="salary" placeholder="$100,000 (input amount in year)" required></x-form-input>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
          <a href="/jobs" class="text-sm/6 font-semibold text-gray-900">Cancel</button>
